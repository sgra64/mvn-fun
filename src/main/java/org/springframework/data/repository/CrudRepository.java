...
//@svgr import org.springframework.dao.OptimisticLockingFailureException;
 ...
 */
//@svgr @NoRepositoryBean
public interface CrudRepository<T, ID> { //@svgr extends Repository<T, ID> {
